...
(asdf:defsystem sb-rotate-byte
  ...
  :perform (asdf:load-op :after (o c) (provide 'sb-rotate-byte))
  :perform (asdf:test-op (o c) (test-system 'sb-rotate-byte/tests)))


(asdf:defsystem sb-rotate-byte/tests
  #+sb-building-contrib :pathname
  #+sb-building-contrib #p"SYS:CONTRIB;SB-ROTATE-BYTE;"
